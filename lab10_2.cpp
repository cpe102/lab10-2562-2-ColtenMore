...
int main(){	
	...
	int playerCards[3] = {drawCard(), drawCard2(), 0};
	int yugiCards[3] = {drawCard3(), drawCard4(), 0}; //This line of code is not completed. You need to initialize value of yugiCards[].
